    ...
    <div className="method_container">
      ...
      <div className="paragraph_container">
        ...
        <p className="paragraph">
          ...
          Gesamtwerts) <br />
          2. Klasse B: Mittlere Anzahl von Objekten mit mittlerem Wertanteil (20
          Prozent des Gesamtwerts) <br />
        ...
        <p className="paragraph">
          ...
          berechnen. <br />
          3. Sortieren: Materialien nach ihrem Jahresverbrauchswert absteigend
          ordnen. <br />
          4. Kumulierter Anteil: Den kumulierten Anteil des Werts berechnen und
          die Materialien in A,B,C unterteilen. <br />
        </p>
      </div>
    </div>
  );
